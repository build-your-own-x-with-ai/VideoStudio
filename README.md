...
│   │   ├── VideoAnalyzerThread.h/cpp # 异步分析线程
│   │   ├── BitrateAnalyzer.h/cpp # 比特率分析器
│   │   ├── GOPAnalyzer.h/cpp   # GOP 结构分析器
│   │   ├── Exporter.h/cpp      # 数据导出器
│   │   ├── FrameInfo.h         # 帧信息数据结构
...
│       ├── BitrateChart.h/cpp  # 比特率图表
│       └── GOPViewer.h/cpp     # GOP 结构视图
├── resources/                  # 资源文件
└── build/                      # 构建目录
```
