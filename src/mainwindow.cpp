...
void MainWindow::applyTheme(const QString& theme) {
    if (theme == "dark") {
        qApp->setStyleSheet(
            ...
            "QMenuBar { background-color: #2d2d30; color: #ffffff; border-bottom: 1px solid #3e3e42; }"
            ...
            "QMenu::separator { height: 1px; background: #3e3e42; margin: 2px 0px; }"
            "QDockWidget { background-color: #2b2b2b; color: #d4d4d4; titlebar-close-icon: url(close.png); titlebar-normal-icon: url(float.png); }"
            "QDockWidget::title { background-color: #2d2d30; padding: 4px; border: 1px solid #3e3e42; }"
            "QTreeWidget, QTableWidget, QListWidget { background-color: #1e1e1e; color: #d4d4d4; border: 1px solid #3e3e42; }"
            "QTreeWidget::item:hover, QTableWidget::item:hover, QListWidget::item:hover { background-color: #2a2d2e; }"
            "QTreeWidget::item:selected, QTableWidget::item:selected, QListWidget::item:selected { background-color: #094771; }"
            "QHeaderView::section { background-color: #2d2d30; color: #d4d4d4; padding: 4px; border: 1px solid #3e3e42; }"
            "QPushButton { background-color: #3e3e42; color: #ffffff; border: 1px solid #555555; padding: 4px 12px; border-radius: 2px; }"
            "QPushButton:hover { background-color: #505050; border: 1px solid #007acc; }"
            "QPushButton:pressed { background-color: #094771; }"
            "QLineEdit, QTextEdit, QPlainTextEdit, QSpinBox, QDoubleSpinBox { background-color: #1e1e1e; color: #d4d4d4; border: 1px solid #3e3e42; padding: 2px; selection-background-color: #094771; }"
            "QLineEdit:focus, QTextEdit:focus, QPlainTextEdit:focus, QSpinBox:focus, QDoubleSpinBox:focus { border: 1px solid #007acc; }"
            "QComboBox { background-color: #3e3e42; color: #ffffff; border: 1px solid #555555; padding: 2px 8px; }"
            "QComboBox:hover { border: 1px solid #007acc; }"
            "QComboBox::drop-down { border: none; }"
            "QComboBox QAbstractItemView { background-color: #2d2d30; color: #ffffff; selection-background-color: #094771; border: 1px solid #3e3e42; }"
            "QScrollBar:vertical { background-color: #2b2b2b; width: 14px; border: none; }"
            "QScrollBar::handle:vertical { background-color: #555555; min-height: 20px; border-radius: 4px; }"
            "QScrollBar::handle:vertical:hover { background-color: #6e6e6e; }"
            "QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { height: 0px; }"
            "QScrollBar:horizontal { background-color: #2b2b2b; height: 14px; border: none; }"
            "QScrollBar::handle:horizontal { background-color: #555555; min-width: 20px; border-radius: 4px; }"
            "QScrollBar::handle:horizontal:hover { background-color: #6e6e6e; }"
            "QScrollBar::add-line:horizontal, QScrollBar::sub-line:horizontal { width: 0px; }"
            "QToolBar { background-color: #2d2d30; border-bottom: 1px solid #3e3e42; spacing: 4px; }"
            "QToolButton { background-color: transparent; color: #d4d4d4; border: none; padding: 4px; }"
            "QToolButton:hover { background-color: #3e3e42; }"
            "QToolButton:pressed { background-color: #094771; }"
            "QStatusBar { background-color: #2d2d30; color: #d4d4d4; border-top: 1px solid #3e3e42; }"
            "QLabel { color: #d4d4d4; background-color: transparent; }"
            "QTabWidget::pane { border: 1px solid #3e3e42; background-color: #2b2b2b; }"
            "QTabBar::tab { background-color: #2d2d30; color: #d4d4d4; padding: 6px 12px; border: 1px solid #3e3e42; }"
            "QTabBar::tab:selected { background-color: #2b2b2b; border-bottom: 2px solid #007acc; }"
            "QTabBar::tab:hover { background-color: #3e3e42; }"
            "QProgressBar { background-color: #1e1e1e; border: 1px solid #3e3e42; border-radius: 2px; text-align: center; color: #d4d4d4; }"
            "QProgressBar::chunk { background-color: #007acc; }"
        );
    } else {
        qApp->setStyleSheet(
            "QMainWindow { background-color: #ffffff; }"
            "QWidget { background-color: #f5f5f5; color: #2d2d30; }"
            "QMenuBar { background-color: #f0f0f0; color: #2d2d30; border-bottom: 1px solid #d4d4d4; }"
            "QMenuBar::item { padding: 4px 8px; background-color: transparent; }"
            "QMenuBar::item:selected { background-color: #e5e5e5; }"
            "QMenu { background-color: #ffffff; color: #2d2d30; border: 1px solid #d4d4d4; }"
            "QMenu::item { padding: 4px 24px; }"
            "QMenu::item:selected { background-color: #cce8ff; }"
            "QMenu::separator { height: 1px; background: #d4d4d4; margin: 2px 0px; }"
            "QDockWidget { background-color: #f5f5f5; color: #2d2d30; }"
            "QDockWidget::title { background-color: #f0f0f0; padding: 4px; border: 1px solid #d4d4d4; }"
            "QTreeWidget, QTableWidget, QListWidget { background-color: #ffffff; color: #2d2d30; border: 1px solid #d4d4d4; }"
            "QTreeWidget::item:hover, QTableWidget::item:hover, QListWidget::item:hover { background-color: #f0f0f0; }"
            "QTreeWidget::item:selected, QTableWidget::item:selected, QListWidget::item:selected { background-color: #cce8ff; }"
            "QHeaderView::section { background-color: #f0f0f0; color: #2d2d30; padding: 4px; border: 1px solid #d4d4d4; }"
            "QPushButton { background-color: #ffffff; color: #2d2d30; border: 1px solid #adadad; padding: 4px 12px; border-radius: 2px; }"
            "QPushButton:hover { background-color: #e5e5e5; border: 1px solid #0078d4; }"
            "QPushButton:pressed { background-color: #cce8ff; }"
            "QLineEdit, QTextEdit, QPlainTextEdit, QSpinBox, QDoubleSpinBox { background-color: #ffffff; color: #2d2d30; border: 1px solid #adadad; padding: 2px; selection-background-color: #cce8ff; }"
            "QLineEdit:focus, QTextEdit:focus, QPlainTextEdit:focus, QSpinBox:focus, QDoubleSpinBox:focus { border: 1px solid #0078d4; }"
            "QComboBox { background-color: #ffffff; color: #2d2d30; border: 1px solid #adadad; padding: 2px 8px; }"
            "QComboBox:hover { border: 1px solid #0078d4; }"
            "QComboBox::drop-down { border: none; }"
            "QComboBox QAbstractItemView { background-color: #ffffff; color: #2d2d30; selection-background-color: #cce8ff; border: 1px solid #adadad; }"
            "QScrollBar:vertical { background-color: #f5f5f5; width: 14px; border: none; }"
            "QScrollBar::handle:vertical { background-color: #c8c8c8; min-height: 20px; border-radius: 4px; }"
            "QScrollBar::handle:vertical:hover { background-color: #a0a0a0; }"
            "QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { height: 0px; }"
            "QScrollBar:horizontal { background-color: #f5f5f5; height: 14px; border: none; }"
            "QScrollBar::handle:horizontal { background-color: #c8c8c8; min-width: 20px; border-radius: 4px; }"
            "QScrollBar::handle:horizontal:hover { background-color: #a0a0a0; }"
            "QScrollBar::add-line:horizontal, QScrollBar::sub-line:horizontal { width: 0px; }"
            "QToolBar { background-color: #f0f0f0; border-bottom: 1px solid #d4d4d4; spacing: 4px; }"
            "QToolButton { background-color: transparent; color: #2d2d30; border: none; padding: 4px; }"
            "QToolButton:hover { background-color: #e5e5e5; }"
            "QToolButton:pressed { background-color: #cce8ff; }"
            "QStatusBar { background-color: #f0f0f0; color: #2d2d30; border-top: 1px solid #d4d4d4; }"
            "QLabel { color: #2d2d30; background-color: transparent; }"
            "QTabWidget::pane { border: 1px solid #d4d4d4; background-color: #f5f5f5; }"
            "QTabBar::tab { background-color: #f0f0f0; color: #2d2d30; padding: 6px 12px; border: 1px solid #d4d4d4; }"
            "QTabBar::tab:selected { background-color: #ffffff; border-bottom: 2px solid #0078d4; }"
            "QTabBar::tab:hover { background-color: #e5e5e5; }"
            "QProgressBar { background-color: #ffffff; border: 1px solid #d4d4d4; border-radius: 2px; text-align: center; color: #2d2d30; }"
